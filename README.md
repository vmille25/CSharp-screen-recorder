...
1. Create a .NET App project on the .NET Framework
2. Add the SharpAVI Nuget Package
3. Add references to System.Drawing and System.Windows.Forms
4. Create a new class called RecorderParams.cs
...
5. Program.cs file should look like this:
```csharp
using System;
...
6. Run the application and ensure proper functionality.
7. Check the results by going to the project's working directory /bin/debug/out.avi 
